...
private static final long serialVersionUID = 1L;
	 ...
	 *
	 * d'ailleur l'absence de implements serializable fait bugguï¿½ le projet, impossible de le lancer 
	 *
	 * lï¿½annotation @Inject permet lï¿½injection et se base sur le type et non sur des expressions EL comme
	 * lï¿½annotation @ManagedProperty utilisï¿½e avec lï¿½annotation @ManagedBean.
	 * 
	 * Donc 
	 *
