...
-- Configuration des propriétés du DataSource (dans Glassfish) :
-- Nom du pool : Si_etu
...
create table ETUDIANT_FORMATION (ETUDIANT_ID int not null, FORMATION_ID int not null, datedebut date, datefin date, description varchar(255), resultat varchar(70), primary key (ETUDIANT_ID, FORMATION_ID));
...
INSERT INTO ETUDIANT_ENTREPRISE VALUES ('2011-06-01',2,1,'Aucun','2012-08-01','Analyse les besoins du client et met en place le developpement','Ingénieur Etudes et Developpement','INTERIM');
INSERT INTO ETUDIANT_ENTREPRISE VALUES ('2011-06-01',2,2,'Aucun','2013-08-01','Met en place le reseau de l''entreprise','Ingénieur Systemes et Reseaux','STAGE');
