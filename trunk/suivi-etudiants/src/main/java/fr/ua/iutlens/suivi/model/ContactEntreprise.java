...
public class ContactEntreprise extends BaseEntity implements Serializable {
	...
	// clé étrangère : une adresse de contact appartient à une et une seule entreprise.
