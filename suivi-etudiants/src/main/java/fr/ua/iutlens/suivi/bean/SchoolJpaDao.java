...
import fr.ua.iutlens.suivi.model.Person;
import fr.ua.iutlens.suivi.model.Student;
import fr.ua.iutlens.suivi.model.Teacher;
import fr.ua.iutlens.suivi.qualifier.DataRepository;
...
public class SchoolJpaDao implements SchoolDao {
	...
	/* (non-Javadoc)
	 * @see fr.ua.iutlens.suivi.bean.SchoolDao#searchStudents(fr.ua.iutlens.suivi.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
