...
public class ActivitePro extends BaseEntity implements Serializable {
	...
	// champs date_deb_activite, date_fin_activite (on récupère uniquement le jour/mois/année)
	...
	// champs description_activite, commentaire_activite
